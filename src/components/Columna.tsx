...
const Columna = () => {
  ...
  return (
    <section id="articulos" className="px-10 py-40 bg-orange-50 scroll-mt-[77.19px]">
      <div className="max-w-[1000px] mx-auto">
        <h2 className=" mx-auto text-center text-3xl md:text-5xl font-anton text-orange-500 font-black uppercase">

...
const Carousel = () => {
  ...
  return (
    <section className="w-full bg-orange-50 ">
      <div className="max-w-[500px] md:max-w-[1000px] mx-auto relative px-14 md:px-20 py-10">
        <Slider {...settings}>
          {
            data.map((element, key) => (
              <div>
                <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-20 max-[768px]:gap-10 justify-content-center">
                  ...
                  <p className="font-montserrat pr-10 text-xl leading-relaxed max-[1024px]:text-xl max-[768px]:pr-0  ">{element.text}</p>
                </div>
              </div>
            ))
          }
